...
func octets_to_64_bits_little_indian(one: felt, two: felt, three: felt, four: felt) -> (res: felt) {
...
func split_64_bits{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(in: felt) -> (
    five_bytes: felt, three_bytes: felt
) {
    alloc_locals;
...
func get_pedersen_hash{range_check_ptr, pedersen_ptr: HashBuiltin*}(
    suite_string: felt, public_key: EcPoint, alpha: felt, ctr: felt
) -> (res: felt) {
...
func hash_to_curve{range_check_ptr, bitwise_ptr: BitwiseBuiltin*, pedersen_ptr: HashBuiltin*}(
    suite_string: felt, public_key: EcPoint, alpha: felt
) -> (point_on_curve: EcPoint) {
    alloc_locals;
